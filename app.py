                ...
                with gr.Row():
                    ...
                    with gr.Column(scale=7):
                        with gr.Row():
                            ...
                            brush_index = gr.Number(value=0, label="Feature index", minimum=0, maximum=5119, elem_id="brush_index", precision=0)
                        with gr.Row():
...
def create_intro_part():
    with gr.Tab("Instructions", elem_classes="tabs") as intro_tab:
        gr.Markdown(
            ...
            * Use the "Feature Icon" button to understand how the selected feature functions.

            ### Remarks
            * Not all features mix well with all images. Experiment with different features and strengths.
